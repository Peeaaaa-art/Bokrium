...
import KanbanColumnController from "./controllers/kanban_column_controller";
...
import RoadmapController from "./controllers/roadmap_controller";
...
application.register("kanban-column", KanbanColumnController);
